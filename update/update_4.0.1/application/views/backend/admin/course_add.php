                                    ...
                                    <div class="tab-pane" id="basic">
                                        <div class="row justify-content-center">
                                            <div class="col-xl-8">
												...
												<div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label" for="urlpg">LINK DE PAGAMENTO <span class="required">*</span> </label>
                                                    <div class="col-md-10">
                                                        <textarea class="form-control" id="urlpg" name ="urlpg"></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-3">
