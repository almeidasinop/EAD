                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-xl-8">
                                                <div class="form-group row mb-3">
												    ...
												    <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label" for="urlpg"> LINK DE PAGAMENTO </label>
                                                    <div class="col-md-10">
                                                        <textarea name="urlpg" id = "urlpg" class="form-control"><?php echo $course_details['urlpg']; ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-3">
