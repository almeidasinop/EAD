...
$status_wise_transactions = $this->crud_model->get_status_wise_transactions();
?>
<!-- ========== Left Sidebar Start ========== -->
<div class="left-side-menu left-side-menu-detached">
	...
	<li class="side-nav-item">
			<a href="<?php echo site_url('admin/pagseguro'); ?>" class="side-nav-link">
				<i class="dripicons-store"></i>
				<span><?php echo get_phrase('pagseguro_history'); ?></span>
			</a>
		</li>
