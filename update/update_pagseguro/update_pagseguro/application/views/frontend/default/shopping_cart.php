        ...
        <div class="row" id = "cart_items_details">
            <div class="col-lg-9">
                ...
                <div class="in-cart-box">
                    <div class="title">Por favor, selecione apenas um curso.</div>
                    <div class="">
                ...
                <div class="cart-sidebar">
                    ...
                    <div class="total-original-price">
                        ...
                        <!-- <span class="discount-rate">95% off</span> -->
                                  ...
                                  <a href="javascript::" onclick="handleCheckOut1()" class="btn btn-primary btn-block checkout-btn"><?php echo get_phrase('checkout'); ?></a> </a>
                </div>
            </div>
        </div>
    </div>
